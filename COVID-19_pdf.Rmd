...
load(file = "Bevoelkerung2019.RData")
N <- Daten2019.2[1]*1e3
```
...
Sozialkontakten und deren Auswirkung auf die Pandemie sowie die Herdenimmunität 
...
Neben den beobachteten Letalitäten finden sich in der Arbeit von Verity et al.
...
den Altersgruppen. Die Gesamtzahl der Toten bei einer Durchseuchung von 
...
Millionen Toten in Deutschland, wobei die statistische Unsicherheit deutlich 
