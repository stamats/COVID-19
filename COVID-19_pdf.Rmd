...
```{r, fig.height=5, fig.width=7, fig.cap="Letalitäten in China vom 01.01.2020 bis zum 11.02.2020 (inkl. 95%-KI)."}
library(MKinfer)
p.0.20 <- (0+1)/(416+549)
...
```{r, fig.height=5, fig.width=7, fig.cap="Erwartete Anzahl von Toten pro Altersgruppe in Deutschland zum 06.04.2020 (inkl. 95%-KI)."}
M <- 36081+1810
p.krank <- M/N
M.tot <- 1810
p.tot <- M.tot/M
